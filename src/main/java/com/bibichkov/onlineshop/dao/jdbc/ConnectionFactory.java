...
public class ConnectionFactory implements DataSource {
    ...
    public ConnectionFactory(Properties properties) throws SQLException{
        ...
        this.connection = new CachedConnection(realConnection);
    }


    @Override
    public Connection getConnection(){
        CachedConnection connection = this.connection;
